const FEATURES = [
    "تسجيلات القرآن الكريم لنخبة من القراء المعاصرين و الراحلين",
    "16 طابعة للمصاحف لنسخة الكمبيوتر و نسخة الهاتف تصميم عصري",
    ...
    "أسماء رسول الله ﷺ وشرح معانيها",
    "العشرة المبشرين بالجنة مع نبذه عنهم",
    "الموسوعة التارخية لنسخة الأندرويد",
    "كتب أحاديث كاملة نسخة الأندرويد",
...
function initScreenshotSections() {
    ...
    appendSequentialScreenshotItems("android-image-list", {
        basePath: "./image/android",
        altPrefix: "screenshot android",
        maxImagesToCheck: 80,
